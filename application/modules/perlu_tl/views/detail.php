...
function save(){ 
			...
			//CKEDITOR.instances[instance].updateElement();
				...
				$.ajax({
					url:'<?php echo base_url();?>approve_atasan_tm/approve_atasan_tm/save',
					type:"post",
					data: formData,
					processData:false,
					contentType:false,
					...
					success: function(data){
						if(data['sukses'] == 1){
							setTimeout(function(){
								...
								loadMainContent('approve_atasan_tm');
							},1000);
						}
	...
	function revisi(){ 
			...
			//CKEDITOR.instances[instance].updateElement();
				...
				//formData.append('t_lampiran', $('input[type=file]')[0].files[0]);
				$.ajax({
					url:'<?php echo base_url();?>approve_atasan_tm/approve_atasan_tm/revisi',
					type:"post",
					data: formData,
					processData:false,
					contentType:false,
			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0 font-size-18">Detail Task Management</h4>
							<div class="page-title-right">
								<ol class="breadcrumb m-0">
									<li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
									<a href="#" onclick="loadMainContent('perlu_tl/perlu_tl/index')" class="image-link"><li class="breadcrumb-item active">/ Task Management</li></a>
								</ol>
							</div>
					</div>
				</div>
                    ...
                    <div class="card">
                        <div class="card-body">
							...
							<div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                   <textarea class="form-control" id="catatan_kabag_it" name="catatan_kabag_it" rows="3" placeholder="" readonly><?=$data_tm['catatan_kabag_it']?></textarea>
                                </div>
                            </div>
							
							
							<div class="mb-3 row">
                                <label for="example-tel-input" class="col-md-2 col-form-label">Level SLA</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="text" value="<?=$data_tm['level_sla']?>" placeholder="" id="tipe" name="tipe" readonly>
                                </div>
                            </div>
