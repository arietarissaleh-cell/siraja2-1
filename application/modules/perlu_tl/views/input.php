...
function done(){ 
			...
			//CKEDITOR.instances[instance].updateElement();
				...
				$.ajax({
					url:'<?php echo base_url();?>perlu_tl/perlu_tl/done',
					type:"post",
					data: formData,
					processData:false,
					contentType:false,
	...
	function proses(){ 
			...
			//CKEDITOR.instances[instance].updateElement();
				...
				//formData.append('t_lampiran', $('input[type=file]')[0].files[0]);
				$.ajax({
					url:'<?php echo base_url();?>perlu_tl/perlu_tl/proses',
					type:"post",
					data: formData,
					processData:false,
					contentType:false,
			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0 font-size-18">Task Preparation</h4>
                    ...
                    <div class="card">
						...
						<div class="text-sm-end">
							<div class="btn-group me-2 mb-2 mb-sm-0 ">
								<a href="javascript:void(0);" class="btn btn-primary waves-light waves-effect dropdown-toggle" onClick="loadMainContent('perlu_tl/perlu_tl/index')" > 
							...
							<div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" value="<?=$data_tm['nama_pembuat']?>" id="pembuat" name="pembuat" readonly>
							...
							<div class="mb-3 row">
                                <label for="example-search-input" class="col-md-2 col-form-label">Bagian</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="text" value="<?=$data_tm['bagian']?>" id="atasan" name="atasan" readonly>
							...
							<div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" value="<?=$data_tm['pic']?>" placeholder="" id="tipe" name="tipe" readonly>
                                </div>
                            </div>
							
							
							<div class="mb-3 row">
                                <label for="example-password-input" class="col-md-2 col-form-label">Catatan Tindak Lanjut</label>
                                <div class="col-md-10">
                                   <textarea class="form-control" id="catatan_tl" name="catatan_tl" rows="3" placeholder="" ></textarea>
                                </div>
                            </div>
							
							<div class="mb-3 row">
                                <label for="example-tel-input" class="col-md-2 col-form-label">Toko</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="text" value="" placeholder="" id="toko" name="toko">
                                </div>
                            </div>
							
							<div class="mb-3 row">
                                <label for="example-tel-input" class="col-md-2 col-form-label">Tanggal Pick UP</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="date" value="" placeholder="" id="tgl_pickup" name="tgl_pickup">
                                </div>
                            </div>
							
							<div class="mb-3 row">
                                <label for="example-tel-input" class="col-md-2 col-form-label">Estimasi Selesai</label>
                                <div class="col-md-10">
                                    <input class="form-control" type="date" value="" placeholder="" id="estimasi_selesai" name="estimasi_selesai">
                                </div>
                            </div>
							
							<div class="mb-3 row">
                                <div class="text-end">
                                    <a href="javascript:void(0);" class="btn btn-success" onClick="done();"><i class="mdi mdi-send me-1"></i> Done</a>
                                    <a href="javascript:void(0);" class="btn btn-success" onClick="proses();"><i class="mdi mdi-send me-1"></i> Proses</a>
                                </div>
                            </div> 
							
							<div class="mb-3 row">
							<?php
							$dokumen ='https://siraja.rajawali2.co.id/siraja/doc_tm/'.$data_tm['nama_file'];
							if ($data_tm['nama_file'] != null){
							?>
							<div class="ratio ratio-4x3">
								<iframe src='<?=$dokumen;?>' allowfullscreen webkitallowfullscreen></iframe>
								</div>
							<?php } else {?>
							<div class="ratio ratio-4x3">
								<label for="example-password-input" class="col-md-2 col-form-label">TIDAK ADA LAMPIRAN</label>
							</div>
							<?php } ?>
							</div>
