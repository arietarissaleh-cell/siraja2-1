...
class Menus_shortcut_model extends Base_Model {

    function __construct() {

        parent::__construct();
		$this->set_schema('hrms');
		$this->set_table('app_menus_shortcut');
	...
	{
		$this->db->select('tbl.*');
		$this->db->join('hrms.app_menus_shortcut_priv prv','tbl.id_app_menu_shortcut = prv.fid_app_menu_shortcut','');
	...
	{       
		...
		$this->db->join('(SELECT * 
							FROM hrms.app_menus_shortcut_priv
