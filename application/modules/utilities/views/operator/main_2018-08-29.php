<script type="text/javascript">
	...
	{
		bootbox.confirm('Anda yakin data : <br>'+$('#username_'+id).val()+' akan di Hapus?', 
			function(e){
				if (e){
	...
	<div class="widget widget-inverse" id="main-list">
		<div class="widget-head">
			<div class="btn-group pull-right">
				...
				<a class="btn btn-inverse" title="Tambah" href="javascript:void(0);" onClick="loadInput('utilities/operator/input')"><i class="fa fa-plus-square"></i></a>
